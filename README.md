...
|---|---|---|
| **[Fire Detection System](https://github.com/sarthakkaushik927)** &mdash; real-time fire & smoke monitoring | React.js &bull; Express.js &bull; Mapbox GL &bull; Socket.io &bull; OpenCV | NASA FIRMS API integration, 3D terrain mapping, sub-1s alert delivery |
| **[NextGen Assessment Systems](https://github.com/sarthakkaushik927)** &mdash; scalable coding platform | React 19 &bull; TypeScript &bull; Node.js &bull; MongoDB &bull; Redis &bull; AWS ECS | Self-hosted Judge0 behind a custom load balancer, 250+ concurrent sessions, SSE live results |
| **Probation Portal** &mdash; trainee evaluation system (CCC AKGEC) | Next.js &bull; Tailwind v4 &bull; MongoDB | Tracks 180+ trainees across six technical domains at 100% accuracy |
...
![Tailwind](https://img.shields.io/badge/-Tailwind_CSS-1a0b2e?style=flat-square&logo=tailwindcss&logoColor=06B6D4)
